...
export const GraphqlLoader = (args?: GraphqlLoaderOptions) => {
  ...
  return (target, property, descriptor) => {
    ...
    descriptor.value = function (...args) {
      ...
      if (!loader.req) {
        loader.req = {} as IncomingMessage & ILoaderInstance;
      }
      ...
      if (options.polymorphic) {
        if (typeof options.polymorphic === 'function') {
          return loader.req._loader[loaderKey].load(
            options.polymorphic(loader.parent),
          );
        } else if (
          loader.parent[options.polymorphic.id] &&
          loader.parent[options.polymorphic.descriminator]
        ) {
          return loader.req._loader[loaderKey].load({
        ...
        if (typeof options.foreignKey === 'function') {
          return loader.req._loader[loaderKey].load(
            options.foreignKey(loader.parent),
          );
