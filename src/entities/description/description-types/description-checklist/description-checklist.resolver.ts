...
import { GraphqlLoader, Loader, LoaderData } from '../../../../../loader-lib';

@Resolver(() => DescriptionChecklistObjectType)
export class DescriptionChecklistResolver {
  constructor(
    @InjectRepository(DescriptionChecklistItem)
    private readonly descriptionChecklistItemRepository: Repository<DescriptionChecklistItem>,
  ) {}
  ...
  async items(
    ...
    const qb = await this.descriptionChecklistItemRepository
